...
function resolve(props, env) {
  let { service, entrypoint } = props, target = resolveTarget(service);
  ...
  return env.DEV_REGISTRY_DEBUG_PORT.connect(target.debugPortAddress).getEntrypoint(serviceName, entrypoint ?? void 0);
}
