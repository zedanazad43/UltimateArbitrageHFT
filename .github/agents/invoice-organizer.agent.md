...
user-invocable: true
argument-hint: "Task for invoice-organizer skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **invoice-organizer** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show invoice-organizer
python aimaster/run.py skills run invoice-organizer "your task"
`
