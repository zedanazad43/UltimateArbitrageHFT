...
user-invocable: true
argument-hint: "Task for lead-research-assistant skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **lead-research-assistant** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show lead-research-assistant
python aimaster/run.py skills run lead-research-assistant "your task"
`
