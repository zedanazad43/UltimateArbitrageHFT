...
user-invocable: true
argument-hint: "Task for domain-name-brainstormer skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **domain-name-brainstormer** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show domain-name-brainstormer
python aimaster/run.py skills run domain-name-brainstormer "your task"
`
