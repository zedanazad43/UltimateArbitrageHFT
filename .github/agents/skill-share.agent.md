...
user-invocable: true
argument-hint: "Task for skill-share skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **skill-share** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show skill-share
python aimaster/run.py skills run skill-share "your task"
`
