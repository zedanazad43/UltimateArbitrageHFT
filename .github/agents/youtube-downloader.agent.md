...
user-invocable: true
argument-hint: "Task for youtube-downloader skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **youtube-downloader** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show youtube-downloader
python aimaster/run.py skills run youtube-downloader "your task"
`
