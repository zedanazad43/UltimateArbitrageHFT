...
user-invocable: true
argument-hint: "Task for image-enhancer skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **image-enhancer** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show image-enhancer
python aimaster/run.py skills run image-enhancer "your task"
`
