...
user-invocable: true
argument-hint: "Task for tailored-resume-generator skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **tailored-resume-generator** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show tailored-resume-generator
python aimaster/run.py skills run tailored-resume-generator "your task"
`
