...
user-invocable: true
argument-hint: "Task for mcp-builder skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **mcp-builder** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show mcp-builder
python aimaster/run.py skills run mcp-builder "your task"
`
