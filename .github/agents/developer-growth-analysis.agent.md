...
user-invocable: true
argument-hint: "Task for developer-growth-analysis skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **developer-growth-analysis** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show developer-growth-analysis
python aimaster/run.py skills run developer-growth-analysis "your task"
`
