...
user-invocable: true
argument-hint: "Task for langsmith-fetch skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **langsmith-fetch** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show langsmith-fetch
python aimaster/run.py skills run langsmith-fetch "your task"
`
