...
user-invocable: true
argument-hint: "Task for content-research-writer skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **content-research-writer** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show content-research-writer
python aimaster/run.py skills run content-research-writer "your task"
`
