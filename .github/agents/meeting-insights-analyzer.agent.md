...
user-invocable: true
argument-hint: "Task for meeting-insights-analyzer skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **meeting-insights-analyzer** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show meeting-insights-analyzer
python aimaster/run.py skills run meeting-insights-analyzer "your task"
`
