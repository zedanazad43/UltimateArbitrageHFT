...
user-invocable: true
argument-hint: "Task for competitive-ads-extractor skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **competitive-ads-extractor** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show competitive-ads-extractor
python aimaster/run.py skills run competitive-ads-extractor "your task"
`
