...
user-invocable: true
argument-hint: "Task for raffle-winner-picker skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **raffle-winner-picker** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show raffle-winner-picker
python aimaster/run.py skills run raffle-winner-picker "your task"
`
