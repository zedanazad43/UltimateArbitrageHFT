...
user-invocable: true
argument-hint: "Task for twitter-algorithm-optimizer skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **twitter-algorithm-optimizer** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show twitter-algorithm-optimizer
python aimaster/run.py skills run twitter-algorithm-optimizer "your task"
`
