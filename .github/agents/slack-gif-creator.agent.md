...
user-invocable: true
argument-hint: "Task for slack-gif-creator skill to complete"
source: "ComposioHQ/awesome-claude-skills"
---

You are the **slack-gif-creator** skill agent - loaded from awesome-claude-skills.
...
`ash
python aimaster/run.py skills show slack-gif-creator
python aimaster/run.py skills run slack-gif-creator "your task"
`
