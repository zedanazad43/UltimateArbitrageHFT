 ...
 * @returns {Array|object|null}    Array of top opportunities or single best (for backward compatibility)
 */
export function scanTriangular(exchange, fee, prices, topN = 1) {
  if (!prices || typeof prices !== 'object') return topN === 1 ? null : [];
