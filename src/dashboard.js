...
<div class="panel">
  ...
  <button data-admin-action onclick="loadBalances()" style="margin-bottom:10px;padding:6px 10px;background:#3498db;color:#fff;border:none;border-radius:4px;cursor:pointer;font-size:.85em">🔄 تحديث يدوي</button>
